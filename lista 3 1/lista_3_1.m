%%Exercises 3.1 - 1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Find the nodal displacements and reaction forces in the first truss   
%%system shown at right. Also find axial stresses and axial forces
%%for each element. Solve the linear system by separating unknown
%%displacements. Later solve the system using the zeros-and-ones
%%method and compare. Use P = 10 kN and EA = 2000 kN. The
%%lengths for elements 1 and 2 are 1 m and 0.8 m, respectively.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clc
clear
format short
